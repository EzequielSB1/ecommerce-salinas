...
//     <ItemCount onAdd={onAdd} onCount={funcionVerContador} nombre={producto.nombre} precio={producto.precio} stock={producto.stock} init={cartItems} />
//     <Link to="/cart">
